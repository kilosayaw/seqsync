...
export const VISIBLE_JOINT_LIST = JOINT_LIST.filter(j => !j.id.includes('C'));
...
export const DEFAULT_POSE = {
    jointInfo: {
        ...
        // DEFINITIVE FIX: Raised the hips significantly for better proportions (y from 0.0 to 0.1).
...
export const POSE_CONNECTIONS = [
    ['H', 'LS'], ['H', 'RS'], // Using H as a proxy for Neck
