...
const DAMPING_FACTOR = 0.95; // How quickly the spin slows down (0.9 is fast, 0.99 is slow)
const VELOCITY_THRESHOLD = 0.05; // How slow the spin must be to stop completely
