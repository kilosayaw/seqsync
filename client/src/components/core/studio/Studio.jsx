...
const StudioLayout = () => {
    ...
    // FULLY DESTRUCTURED useMotionAnalysis hook
    const {
        isInitializing, isTracking, isAnalyzing, analysisProgress, error,
        livePoseData, startLiveTracking, stopLiveTracking, 
        startFullAnalysis, cancelFullAnalysis
