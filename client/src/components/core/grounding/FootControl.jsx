...
import { FOOT_CONTACT_ZONES } from '../../../utils/constants.js';
// --- THIS IS THE FIX ---
import { getRotationalAccessFromGrounding } from '../../../utils/biomechanics.js';
...
const FootControl = ({ side, groundPoints, rotation, ankleRotation, onRotate, onGroundingChange, onAnkleRotationChange }) => {
    ...
    // This logic goes inside your FootControl component, before the return statement.
    const currentAccess = getRotationalAccessFromGrounding(groundPoints);
    const platterColor = currentAccess.type.includes('Go-To') ? '#3b82f6' :
                         currentAccess.type.includes('Go') ? '#22c55e' :
                         '#64748b';
        ...
        <div className="relative w-[250px] h-[250px] flex flex-col items-center justify-center select-none">
            <div
                ...
                style={{ 
                    ...
                    boxShadow: `0 0 15px 3px ${platterColor}`,
                    transition: 'transform 0.05s linear, box-shadow 0.3s ease-in-out'
                }}
            ...
            <div className="absolute -bottom-16 text-center w-full z-30 space-y-2">
                ...
                <div>
                    <p 
                      ...
                      style={{ color: platterColor }}
                    >
                        {currentAccess.type}
                    </p>
                    <p className="text-sm text-slate-400 uppercase font-semibold">
                        FOOT ROT: <span className="font-mono text-white">{Math.round(rotation)}°</span>
                    </p>
                </div>
            </div>
        </div>
